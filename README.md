...
- HTML & Javascript based Features ( 4 features extracted)
 ...
 All together 17 features are extracted from 5000 URLs of each class and are final dataset is stored in '[Phishing_Detection2.csv](https://github.com/deepeshdm/Phishing-Attack-Domain-Detection/blob/main/Data/Phishing_Detection2.csv)' file in the Data folder of this repository.
